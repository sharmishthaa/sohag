...
const Login = () => {
  ...
  return (
    <div className="login-main-div">
      ...
      >
        <div className='logo' style={{fontSize: "40px", color: "#e2a93c", fontFamily: "cursive"}}>
          {/* <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlh1EN5UEJjJftTwkISHb79T_v0Q0xHAZGwi9hnh1lTOf0GmbTvwf3_kXQP7o4M6iIpM8&usqp=CAU" alt="" /> */}
          Sohag
        </div>
        <Form.Item
          label="Email"
